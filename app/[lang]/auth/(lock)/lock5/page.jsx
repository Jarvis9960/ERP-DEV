            ...
            <div className="basis-full xl:basis-1/2 hidden xl:block relative w-[500px] ">
              ...
              <div className="bg-primary h-full w-full rounded-3xl rounded-tr-none  xl:p-[60px] xl:pr-9 relative  overflow-hidden">
                ...
                <div className="text-xl  mt-2 text-primary-foreground flex gap-1 rtl:pr-12">
                  ...
                  ERP DEV is awesome friendly Admin Dashboard Template. If you
                  manage your business in online then “ERP DEV” is for you. Buy
...
//                   ERP DEV is awesome friendly Admin Dashboard Template. If you manage your business in online then “ERP DEV” is for you. Buy Now & make user friendly your business today...
//                 </div>
...
//                           <div className="text-lg lg:text-xl  font-semibold text-default-900 pr-10 ">
//                             Prantik Chakraborty <br />
//                             <span className="text-base font-medium text-default-700"> UI/UX Designer at Ankit Fukte</span>
//                           </div>
