...
const Footer = () => {
  const socials = [
    {
      icon: facebook,
      href: "https://www.facebook.com/Ankit Fuktebd/"
    },
    {
      icon: github,
      href: "https://github.com/Ankit Fukte-bd"
    },
    {
      icon: linkedin,
      href: "https://www.linkedin.com/company/Ankit Fukte/"
    },
    {
      icon: youtube,
      href: "https://www.youtube.com/@Ankit Fukte4181"
    },
    {
      icon: twitter,
      href: "https://twitter.com/Ankit Fuktebd"
    },
    {
      icon: dribble,
      href: "https://dribbble.com/Ankit Fuktebd"
    },
    {
      icon: behance,
      href: "https://www.behance.net/Ankit Fukte"
    }
  ]
  return (
    <footer
    ...
    >
      <div className="py-16 2xl:py-[120px]">
        <div className="max-w-[700px] mx-auto flex flex-col items-center relative">
          ...
          >
            ...
            <span className="text-3xl font-semibold">ERP DEV</span>
          </Link>
          <p className="text-base leading-7 text-default-200 dark:text-default-600 text-center mt-3">
            ERP DEV is a developer-friendly, ready-to-use admin template designed for building attractive, scalable, and high-performing web applications, powered by the cutting-edge technologies of Next.js and Tailwind CSS.</p>
          <div className="mt-9 flex justify-center flex-wrap gap-4">
            ...
            <Button asChild variant="outline" className="rounded text-primary-foreground border-primary">
              <Link href="https://1.envato.market/ERP DEV-regular" target="__blank">Buy Now</Link>
            </Button>
          </div>
      ...
      <div className="relative bg-default-900 dark:bg-default-50 py-6">
        <div className="container flex flex-col text-center md:text-start md:flex-row gap-2">
          <p className="text-primary-foreground flex-1 text-base xl:text-lg font-medium">COPYRIGHT &copy; 2024 ERP DEV All rights Reserved</p>
          <p className="text-primary-foreground flex-none text-base font-medium">
            Hand-crafted & Made by {" "}
            <Link href="https://Ankit Fukte.net" target="__blank" className="text-primary hover:underline">Ankit Fukte</Link></p>
        </div>
      </div>
    </footer>
  );
